...
class CircularQueue implements ICharQ{
    private char q[]; // this array hols the queue
    private int putloc, getloc; // the put and get indices
...
class DynQueue implements ICharQ{
    ...
    //Construct an empty queque given its size
...
//Demostrate the ICharQ interface
class IQDemo {
    public static void main(String args[]) {
        ...
        iQ = q1;
        //Put some characters into fixes queue.
        for(i=0; i < 10; i++)
            iQ.put((char)('A' + i));
